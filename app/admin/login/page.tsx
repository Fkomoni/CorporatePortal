...
export default function StaffLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (result?.error) {
      setError('Invalid credentials. Please check your Leadway staff email and password.');
    } else {
    ...
    <div style={{ display: 'flex', height: '100vh', fontFamily: 'inherit' }}>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#fff', padding: 32 }}>
        <div style={{ width: '100%', maxWidth: 420 }}>
          ...
          <p style={{ fontSize: 14, color: '#6B7480', marginBottom: 32 }}>Sign in with your Leadway staff credentials to continue.</p>
