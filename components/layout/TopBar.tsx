...
export function TopBar({ title, subtitle, showQuickActions = false }: TopBarProps) {
  return (
    <header className="bg-white border-b border-[#F0F1F5] h-[58px] flex items-center px-6 gap-4 flex-shrink-0">
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative hidden sm:block">
          ...
          <input
            type="text"
            placeholder="Search..."
            className="h-8 pl-8 pr-3 text-[12px] rounded-lg border border-[#E5E7F1] bg-[#F7F8FA] text-[#131C4E] placeholder:text-[#9CA3B8] outline-none focus:border-[#F56B22] focus:bg-white transition-colors w-44"
          />
        </div>
        ...
        <div
          className="w-8 h-8 rounded-full flex items-center justify-center text-white font-bold text-[11px] cursor-pointer"
