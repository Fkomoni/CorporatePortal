...
export type AuditAction =
  ...
  | 'UPDATE_COMPANY_LOGO'
  | 'TERMINATE_MEMBER'
  | 'TERMINATE_MEMBER_FAILED'
  | 'TERMINATE_BENEFICIARY'
  | 'TERMINATE_BENEFICIARY_FAILED'
  | 'UPDATE_MEMBER_INFO'
  | 'SCHEDULE_TERMINATION'
  | 'CANCEL_SCHEDULED_TERMINATION'
  | 'APPROVE_PENDING_ENROLEE'
  | 'APPROVE_PENDING_ENROLEE_FAILED'
  | 'REJECT_PENDING_ENROLEE'
  | 'REJECT_PENDING_ENROLEE_FAILED'
  | 'DISABLE_2FA'
  | 'VIEW_PORTAL_USERS'
  | 'TOGGLE_USER_STATUS'
  | 'VIEW_DASHBOARD'
